...
sed -i 's/src-git lienol https://github.com/Lienol/openwrt-package.git;main/# src-git lienol https://github.com/Lienol/openwrt-package.git;main' feeds.conf.default

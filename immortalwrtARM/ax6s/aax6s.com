...
# CONFIG_TARGET_mediatek_mt7622_DEVICE_bpi_bananapi-r64 is not set
# CONFIG_TARGET_mediatek_mt7622_DEVICE_bpi_bananapi-r64-rootdisk is not set
# CONFIG_TARGET_mediatek_mt7622_DEVICE_elecom_wrc-2533gent is not set
# CONFIG_TARGET_mediatek_mt7622_DEVICE_mediatek_mt7622-rfb1 is not set
# CONFIG_TARGET_mediatek_mt7622_DEVICE_mediatek_mt7622-ubi is not set
# CONFIG_TARGET_mediatek_mt7622_DEVICE_ubnt_unifi-6-lr is not set
CONFIG_TARGET_mediatek_mt7622_DEVICE_xiaomi_redmi-router-ax6s=y
# CONFIG_TARGET_mediatek_mt7622_DEVICE_netgear_wax206 is not set
...
CONFIG_DEFAULT_luci-app-turboacc-mtk=y
CONFIG_DEFAULT_luci-lib-fs=y
CONFIG_DEFAULT_luci-lib-ipkg=y
CONFIG_DEFAULT_mtd=y
CONFIG_DEFAULT_mtkhqos_util=y
...
# CONFIG_PACKAGE_trusted-firmware-a-mt7622-emmc-1ddr is not set
# CONFIG_PACKAGE_trusted-firmware-a-mt7622-emmc-2ddr is not set
# CONFIG_PACKAGE_trusted-firmware-a-mt7622-nor-1ddr is not set
# CONFIG_PACKAGE_trusted-firmware-a-mt7622-nor-2ddr is not set
# CONFIG_PACKAGE_trusted-firmware-a-mt7622-sdmmc-1ddr is not set
# CONFIG_PACKAGE_trusted-firmware-a-mt7622-sdmmc-2ddr is not set
# CONFIG_PACKAGE_trusted-firmware-a-mt7622-snand-1ddr is not set
# CONFIG_PACKAGE_trusted-firmware-a-mt7622-snand-2ddr is not set
# CONFIG_PACKAGE_u-boot-mt7622_bananapi_bpi-r64-emmc is not set
# CONFIG_PACKAGE_u-boot-mt7622_bananapi_bpi-r64-sdmmc is not set
# CONFIG_PACKAGE_u-boot-mt7622_bananapi_bpi-r64-snand is not set
# CONFIG_PACKAGE_u-boot-mt7622_linksys_e8450 is not set
# CONFIG_PACKAGE_u-boot-mt7622_rfb1 is not set
# CONFIG_PACKAGE_u-boot-mt7622_ubnt_unifi-6-lr is not set
# end of Boot Loaders
...
# CONFIG_PACKAGE_kmod-sdhci-mtk is not set
...
CONFIG_PACKAGE_kmod-mt7622=y
CONFIG_MTK_APSOC_WIFI_SUPPORT_OPENWRT=y
CONFIG_MTK_APSOC_WIFI_WIFI_DRIVER=y
CONFIG_MTK_APSOC_WIFI_MT_WIFI=y
CONFIG_MTK_APSOC_WIFI_MT_WIFI_PATH="7622_mt_wifi"
CONFIG_MTK_APSOC_WIFI_FIRST_IF_MT7622=y
# CONFIG_MTK_APSOC_WIFI_FIRST_IF_NONE is not set
CONFIG_MTK_APSOC_WIFI_SECOND_IF_MT7915=y
# CONFIG_MTK_APSOC_WIFI_SECOND_IF_NONE is not set
# CONFIG_MTK_APSOC_WIFI_SECOND_IF_MT7615E is not set
CONFIG_MTK_APSOC_WIFI_THIRD_IF_NONE=y
# CONFIG_MTK_APSOC_WIFI_THIRD_IF_MT7615E is not set
# CONFIG_MTK_APSOC_WIFI_THIRD_IF_MT7915 is not set
CONFIG_MTK_APSOC_WIFI_RT_FIRST_CARD=7622
CONFIG_MTK_APSOC_WIFI_RT_SECOND_CARD=7915
CONFIG_MTK_APSOC_WIFI_RT_FIRST_IF_RF_OFFSET=0xc0000
CONFIG_MTK_APSOC_WIFI_RT_SECOND_IF_RF_OFFSET=0xc8000

#
# WiFi Generic Feature Options
#
CONFIG_MTK_APSOC_WIFI_FIRST_IF_EEPROM_FLASH=y
# CONFIG_MTK_APSOC_WIFI_FIRST_IF_EEPROM_PROM is not set
# CONFIG_MTK_APSOC_WIFI_FIRST_IF_EEPROM_EFUSE is not set
CONFIG_MTK_APSOC_WIFI_RT_FIRST_CARD_EEPROM="flash"
CONFIG_MTK_APSOC_WIFI_SECOND_IF_EEPROM_FLASH=y
# CONFIG_MTK_APSOC_WIFI_SECOND_IF_EEPROM_PROM is not set
# CONFIG_MTK_APSOC_WIFI_SECOND_IF_EEPROM_EFUSE is not set
CONFIG_MTK_APSOC_WIFI_RT_SECOND_CARD_EEPROM="flash"
CONFIG_MTK_APSOC_WIFI_MULTI_INF_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_MT76XX_COMBO_DUAL_DRIVER_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_WIFI_BASIC_FUNC=y
CONFIG_MTK_APSOC_WIFI_DOT11_N_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_DOT11_VHT_AC=y
CONFIG_MTK_APSOC_WIFI_G_BAND_256QAM_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_BRCM_256QAM_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_VHT_TXBF_2G_EPIGRAM_IE_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_TPC_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_ICAP_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_SPECTRUM_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_BACKGROUND_SCAN_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_SMART_CARRIER_SENSE_SUPPORT=y
# CONFIG_MTK_APSOC_WIFI_OFFCHANNEL_SCAN_FEATURE is not set
CONFIG_MTK_APSOC_WIFI_HDR_TRANS_TX_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_HDR_TRANS_RX_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_WSC_INCLUDED=y
CONFIG_MTK_APSOC_WIFI_WSC_V2_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_DOT11W_PMF_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_TXBF_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_FAST_NAT_SUPPORT=y
# CONFIG_MTK_APSOC_WIFI_FTM_SUPPORT is not set
CONFIG_MTK_APSOC_WIFI_IGMP_SNOOP_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_RTMP_FLASH_SUPPORT=y
# CONFIG_MTK_APSOC_WIFI_PRE_CAL_TRX_SET1_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_RLM_CAL_CACHE_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_CAL_BIN_FILE_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_RF_LOCKDOWN_SUPPORT is not set
CONFIG_MTK_APSOC_WIFI_ATE_SUPPORT=y
# CONFIG_MTK_APSOC_WIFI_PASSPOINT_R2 is not set
# CONFIG_MTK_APSOC_WIFI_MBO_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_MAP_SUPPORT is not set
CONFIG_MTK_APSOC_WIFI_UAPSD=y
# CONFIG_MTK_APSOC_WIFI_TCP_RACK_SUPPORT is not set
CONFIG_MTK_APSOC_WIFI_RED_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_FQ_SCH_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_FIRST_IF_IPAILNA=y
# CONFIG_MTK_APSOC_WIFI_FIRST_IF_EPAELNA is not set
# CONFIG_MTK_APSOC_WIFI_FIRST_IF_IPAELNA is not set
CONFIG_MTK_APSOC_WIFI_SECOND_IF_EPAELNA=y
# CONFIG_MTK_APSOC_WIFI_SECOND_IF_IPAILNA is not set
# CONFIG_MTK_APSOC_WIFI_SECOND_IF_IPAELNA is not set
# CONFIG_MTK_APSOC_WIFI_RLT_MAC is not set
# CONFIG_MTK_APSOC_WIFI_RTMP_MAC is not set
# end of WiFi Generic Feature Options

#
# WiFi Operation Modes
#
CONFIG_MTK_APSOC_WIFI_WIFI_MODE_AP=m
# CONFIG_MTK_APSOC_WIFI_WIFI_MODE_STA is not set
# CONFIG_MTK_APSOC_WIFI_WIFI_MODE_BOTH is not set
CONFIG_MTK_APSOC_WIFI_MT_AP_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_WDS_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_MBSS_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_APCLI_SUPPORT=y
# CONFIG_MTK_APSOC_WIFI_APCLI_CERT_SUPPORT is not set
CONFIG_MTK_APSOC_WIFI_MAC_REPEATER_SUPPORT=y
# CONFIG_MTK_APSOC_WIFI_APCLI_CONNECTION_TRIAL is not set
# CONFIG_MTK_APSOC_WIFI_MWDS is not set
CONFIG_MTK_APSOC_WIFI_MUMIMO_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_MU_RA_SUPPORT=y
# CONFIG_MTK_APSOC_WIFI_DOT11R_FT_SUPPORT is not set
CONFIG_MTK_APSOC_WIFI_DOT11K_RRM_SUPPORT=y
# CONFIG_MTK_APSOC_WIFI_ENTERPRISE_AP_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_MLME_MULTI_QUEUE_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_WIFI_EAP_FEATURE is not set
# CONFIG_MTK_APSOC_WIFI_CFG80211_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_MBSS_AS_WDS_AP_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_DSCP_QOS_MAP_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_DSCP_PRI_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_MIN_PHY_RATE_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_FAST_UP_RATE_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_CON_WPS_SUPPORT is not set
CONFIG_MTK_APSOC_WIFI_MCAST_RATE_SPECIFIC=y
CONFIG_MTK_APSOC_WIFI_VOW_SUPPORT=y
CONFIG_MTK_APSOC_WIFI_BAND_STEERING=y
# CONFIG_MTK_APSOC_WIFI_LED_CONTROL_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_WLAN_HOOK is not set
# CONFIG_MTK_APSOC_WIFI_RADIUS_ACCOUNTING_SUPPORT is not set
CONFIG_MTK_APSOC_WIFI_GREENAP_SUPPORT=y
# CONFIG_MTK_APSOC_WIFI_VENDOR_FEATURE11_SUPPORT is not set
CONFIG_MTK_APSOC_WIFI_PCIE_ASPM_DYM_CTRL_SUPPORT=y
# CONFIG_MTK_APSOC_WIFI_COEX_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_EASY_SETUP_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_EVENT_NOTIFIER_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_AIR_MONITOR is not set
CONFIG_MTK_APSOC_WIFI_WNM_SUPPORT=y
# CONFIG_MTK_APSOC_WIFI_INTERWORKING is not set
CONFIG_MTK_APSOC_WIFI_LINUX_NET_TXQ_SUPPORT=y
# CONFIG_MTK_APSOC_WIFI_WPA3_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_OWE_SUPPORT is not set
# CONFIG_MTK_APSOC_WIFI_SINGLE_SKU is not set
# end of WiFi Operation Modes

CONFIG_MTK_APSOC_WIFI_WIFI_MT_MAC=y
CONFIG_MTK_APSOC_WIFI_MT_MAC=y
# CONFIG_MTK_APSOC_WIFI_CHIP_MT7603E is not set
# CONFIG_MTK_APSOC_WIFI_CHIP_MT7615E is not set
CONFIG_MTK_APSOC_WIFI_CHIP_MT7622=y
# CONFIG_MTK_APSOC_WIFI_CHIP_MT7663E is not set
# CONFIG_MTK_APSOC_WIFI_CHIP_MT7626 is not set
CONFIG_MTK_APSOC_WIFI_CHIP_MT7915=y
...
# CONFIG_MTK_SMART_CARRIER_SENSE_SUPPORT is not set
...
# CONFIG_MTK_OCE_SUPPORT is not set
# CONFIG_MTK_MAP_SUPPORT is not set
CONFIG_MTK_UAPSD=y
# CONFIG_MTK_DPP_SUPPORT is not set
...
CONFIG_MTK_WIFI_DBG_TXCMD=y
CONFIG_MTK_MUMIMO_SUPPORT=y
CONFIG_MTK_MUMIMO_PLATFORM_PERFORMANCE_LEVEL=2
...
# CONFIG_MTK_WIFI_EAP_FEATURE is not set
...
# CONFIG_MTK_MCAST_RATE_SPECIFIC is not set
...
# CONFIG_MTK_HWIFI_SUPPORT is not set
...
CONFIG_PACKAGE_luci-app-turboacc-mtk_INCLUDE_PDNSD=y
